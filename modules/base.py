#!/usr/bin/env python3
# modules/base.py — Abstract base class for APIX
...
class BaseModule(ABC):
    ...
    def _finding(self, severity, check, endpoint, detail="") -> dict:
        return {"severity": severity, "check": check, "endpoint": endpoint, "detail": detail}
